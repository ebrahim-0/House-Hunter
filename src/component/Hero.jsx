...
export default function Hero() {
  ...
  return (
    <section className={"w-11/12 mx-auto py-5 p-10 overflow-hidden"}>
      <div className={"img"}>
        <svg
      ...
      <div
        className={"absolute bottom-7 overflow-hidden right-0 flex gap-4 z-20"}
      >
        <div className={"bg-white flex items-center rounded-[32px]"}>
          <img src={"/images/Ellipse1.svg"} className={" "} alt={"Ellipse1"} />
          <img
          ...
          <div className={"-ml-4 pr-6"}>
            ...
            <p className={"whitespace-nowrap"}>Successfully Getting Home</p>
          </div>
        </div>
        <div className={"bg-white flex gap-6 items-center rounded-[32px] p-6"}>
          <img
          ...
          <div className={""}>
            <h1 className={"text-[#1B1C57] font-semibold"}>56 Houses</h1>
            <p className={"whitespace-nowrap"}>Sold Monthly</p>
          </div>
        </div>
        <div className={"bg-white w-[70px] flex items-center rounded-l-[32px]"}>
          <img src={"/images/Ellipse5.png"} className={""} alt={"Ellipse1"} />

          <div className={"-ml-3"}>
            <h1 className={"text-[#1B1C57] font-semibold"}>4K+</h1>
            <p className={"whitespace-nowrap"}>People Looking for New Homes</p>
          </div>
        </div>
      </div>

      <div
        className={"text-[#1B1C57] w-[490px] text-[40px] capitalize font-bold"}
      >
        <h1>find the place to </h1>
        <h1>
          <span>live </span>
          <span className={"text-white font-bold out"}>your dreams{"  "}</span>
        </h1>
        <h1>easily here</h1>
      </div>
      <p
      ...
      <h1
        className={"text-[#626687] text-base leading-7 font-normal opacity-75"}
      >
        Our Partnership
      </h1>
